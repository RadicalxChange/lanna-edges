...
export default function OnboardForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl" autoComplete="off">
      ...
      <p className="text-sm mb-6">Pay $20 to the secretary, either by venmo @matthew-prewitt-1 (noting your email address in the message), or by ETH address 0x10b939BDD4018633709DD243a7412DB581d2E76b (on Optimism please, and communicate your email to Matt in person or on Telegram), or in person. and submit the following attestations, and the admins will verify your account and credit you with 100 ∈.</p>
